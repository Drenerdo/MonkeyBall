...
public class GUI_SelectAni : MonoBehaviour {
	...
	void OnGUI()
	{
		...
		if (GUI.Button(new Rect(20, startY, ButtonWidth, offsetY),aniName)){
			Cat01.animation.wrapMode= WrapMode.Loop;
			Cat01.animation.CrossFade(aniName);	
			Cat02.animation.wrapMode= WrapMode.Loop;
			Cat02.animation.CrossFade(aniName);	
			Cat03.animation.wrapMode= WrapMode.Loop;
			Cat03.animation.CrossFade(aniName);	
			Cat04.animation.wrapMode= WrapMode.Loop;
			Cat04.animation.CrossFade(aniName);	
		}	
		aniName = "Idle02";
